<?php
$url = 'http://localhost/IVMS-API/API/tour/getCompanyTours.php';
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-links">
            ...
            <a href="../scheduled-tours/scheduled-tours.html">View Scheduled Tours</a>
        ...
        <div class="tour-container">
            ...
            if (isset($tourArray['data'][0]['message'])) {
                ...
                foreach ($tourArray['data'] as $key => $item) {
                    // TODO format this, remove unecessary API data, add rate and created_at to the tour card
