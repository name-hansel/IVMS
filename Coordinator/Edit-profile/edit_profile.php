    ...
    <main class="content">
        ...
        <form name="profile" onSubmit="return formValidation()" method="post">
            <div class="form-element">
                <label for="company" class="form-label">Coordinator ID</label>
            ...
            <div class="form-element">
                <label for="phone_number" class="form-label">College</label>
            ...
            <div class="form-element">
                <label for="description" class="form-label">Coordinator email</label>
